...
const required=load('contract-signer-mapping-model').buildRequiredSignerSet(fixture.report).signers;
...
const send={opportunityId:opportunity.id,at,operator:'brad',attemptId:at,status:'accepted',version:fixture.version,templateName:config.documentsContracts.expectedTemplateName,templateSource:'ghl_documents_contracts',requestedTemplateId:config.documentsContracts.templateId,authorizedAt:fixture.authorization.at,signers:required,confirmedRecipientId:contact.id,expirationAt:'2026-10-20T00:00:00.000Z',requestAt:at,iaosObservedAcceptanceAt:at,providerResponse:summary,failureReason:null};
