...
/* Inert-proof for ARV (contact.arv) — STEP 4 ONLY: one PUT that
...
// MONETORY clear semantics UNKNOWN. TEXT clears with "" (KEY_ABSENT, OBSERVED);
// DATE ignores "" and requires null. This PUT tests "" ONLY. If step 5 observes the
// field still present, a separate step-4b sends null under its own approval.
const CLEAR_VALUE     = "";
