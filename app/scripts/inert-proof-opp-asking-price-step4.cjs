/* PB-D60 -- opportunity.asking_price inert proof, step 4 RESTORE.
 * ONE PUT. NO RE-READ.
 *
 * Returns asking_price to KEY_ABSENT using the mechanism PB-D58 section VI
 * OBSERVED rather than assumed: `field_value: ""` clears an opportunity
 * NUMERICAL custom field to KEY_ABSENT, "Reproduced independently on both
 * fields above." No third discovery cycle is run.
 *
 * ⚠ HTTP 200 IS NOT RESTORATION. Step 5 classifies. PB-D24 makes KEY_ABSENT
 * and empty-value-present different states, and step 5 refuses to collapse
 * them.
 *
...
const EVIDENCE = "C:/Users/brad/AppData/Local/Temp/inert-proof-opp-asking-price-step4.json";
...
(async () => {
  ...
  const record = {
    ...
    stage: "restore",
    cycle: "proof",
    note: "PB-D60 field-safety proof, restore stage. HTTP 200 is not success; step 5 classifies.",
