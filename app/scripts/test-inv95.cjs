...
const suites=["write-boundaries","write-webhooks","write-contract-ledgers","arv-persist","repair-persist","legacy-repairs-writer-removed","current-offer-carrier","seller-call-negotiation","seller-call-negotiation-override-note","contract-authorization-model","contract-ghl-projection","contract-projection-sync-carriers","ghl-seller-count-transport-write","contract-send-model","contract-send-guard","contract-send-canonical-carriers","contract-send-reserve","contract-send-execute","contract-send-readback","contract-lifecycle-model","contract-execution-model","contract-disposition-handoff"];
let failed=0;
