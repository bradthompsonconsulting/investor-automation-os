...
const suites=["app-read-auth","write-boundaries","under-contract-stage-result","write-webhooks","disposition-blob-context","write-contract-ledgers","arv-persist","repair-persist","legacy-repairs-writer-removed","current-offer-carrier","seller-call-negotiation","seller-call-negotiation-override-note","contract-authorization-model","contract-ghl-projection","contract-projection-sync-carriers","ghl-seller-count-transport-write","contract-send-model","contract-send-guard","contract-send-canonical-carriers","contract-send-reserve","contract-send-execute","contract-send-readback","contract-lifecycle-model","contract-execution-model","contract-disposition-handoff","contract-workspace-wiring","contract-draft-request","contract-ghl-transport-formatting","contract-seller-signing-model","contract-artifact-verification","generate-contract-pdf-endpoint","contract-stage-and-artifact-model","contract-production-readiness"];
let failed=0;
