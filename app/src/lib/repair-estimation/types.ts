 ...
 *
 * FMTM applied the 10% factor to cost-book category subtotals. Its basis
 * is resolved BOOK-derived priced amounts only; IAOS POLICY reserves and
 * MANUAL amounts are excluded.
 */
